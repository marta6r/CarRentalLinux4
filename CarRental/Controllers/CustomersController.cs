...
namespace CarRental.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, string FullName, string Email, string Phone, string PassportNumber, IFormFile? ImageFile)
        {
        ...
        // Добавьте эти методы в ваш CustomersController.cs
